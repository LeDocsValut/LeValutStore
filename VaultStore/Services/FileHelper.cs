...
namespace SampleApp.Utilities
{
    public static class FileHelpers
    {
        ...
        public static async Task<byte[]> ProcessFormFile<T>(IFormFile formFile, ModelStateDictionary modelState, string[] permittedExtensions, long sizeLimit=Int64.MaxValue)
        {
            ...
            if (formFile.Length > sizeLimit)
            {
                ...
                modelState.AddModelError(formFile.Name,$"{fieldDisplayName}({trustedFileNameForDisplay}) exceeds " +
        ...
        public static async Task<byte[]> ProcessStreamedFile(
            ...
            ModelStateDictionary modelState, string[] permittedExtensions, long sizeLimit=long.MaxValue)
        {
            try
            {
                using (var memoryStream = new MemoryStream())
